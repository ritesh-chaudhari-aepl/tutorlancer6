        ...
        <div className="grid grid-flow-row grid-cols-1 sm:grid-cols-2 max-w-screen-2xl lg:px-20 sm:px-10 px-4  mx-auto">
            <div className="my-auto">
                ...
                <div className="lg:mt-6 mb-3">
                    ...
                    className="inline-block mt-6 mb-3  rounded-sm bg-transparent mr-6 px-8 py-4 text-sm font-semibold bg-contact text-normalWhite  border-2 border-normalWhite  transition  capitalize">Start as Student</button>
