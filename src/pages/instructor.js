...
const Instructor = () => {
  ...
  return (
    <section
      ...
      class="bg-normalWhite sm:pb-24 pb-0"
    >
        ...
        <div class="flex px-6 flex-col items-center gap-3 sm:gap-6 sm:justify-center lg:flex-row sm:ml-0">
          <div class="card1">
            ...
            >
              ...
              <button class="bg-btnColor text-normalWhite text-white font-bold ring-0 rounded px-4 sm:px-2 sm:py-4 py-4 w-1/2">
                Apply Now
              </button>
            </div>
          </div>
          <div class="card2">
            ...
            >
              ...
              <button class="bg-dark text-normalWhite text-white font-bold ring-0 rounded px-4 sm:px-3 sm:py-4 py-4 w-1/2">
                Apply Now
              </button>
            </div>
          </div>
